...
def run_agentic_loop(self, disease: str, cure_required: str, category: str, receptors: str, pdb_file_content: str = None):
    """
    ...
    loop = AgenticLoop(disease, receptors, pdb_file_content)
    ...
    return {
        ...
        "pKa": "7.8",
        "saScore": best_molecule_data["sa_score"],
        "interactingResidues": best_molecule_data["interacting_residues"],
